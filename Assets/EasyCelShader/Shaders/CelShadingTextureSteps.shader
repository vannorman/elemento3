Shader "Xesin Creations/CelShader (Steps by texture)"
{
    Properties
    {
		...
		_LightStepsTexture("Light Steps (Gray scale)", 2D) = "white" {}
        ...
        _FresnelPower("Fresnel Power", Float) = 0.64
	...
	SubShader
    {
        ...
        Pass
        {
            ...
            #pragma fragment forwardFragmentBaseStepsByTexture            
        ...
        Pass
        {
            ...
            #pragma fragment forwardFragmentAddStepsByTexture
    ...
    CustomEditor "XesinCreations.CelShaderEditorByTexture"
}
