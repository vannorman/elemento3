...
Shader "Hidden/Internal-DeferredReflectionsCelshading" {
Properties {
    _SrcBlend ("", Float) = 1
    _DstBlend ("", Float) = 1
}
...
half4 frag (unity_v2f_deferred i) : SV_Target
{
	...
	if(gbuffer0.a != 1.0) {
        ...
        rgb = UNITY_BRDF_PBS (0, data.specularColor, oneMinusReflectivity, data.smoothness, data.normalWorld, -eyeVec, light, ind).rgb;
    }
